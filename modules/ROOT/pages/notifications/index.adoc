...
This page describes both the Neo4j and the GQL-status notification frameworks, how they are structured, their notification objects, and how to interpret them.
