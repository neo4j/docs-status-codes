...
[NOTE]
====
Using differently ordered return items in a UNION [ALL] clause was deprecated in versions 5.5 to 5.25.
However, after cost/benefit analysis and user conversations, it was decided to withdraw the deprecation and continue supporting this feature.
====
