...
==== Example of a shortest path with an unbounded pattern
...
======
=====
==== Example of an exhaustive shortest path
...
Notifications within the deprecation category contain information about a feature or functionality which has been deprecated.
...
==== Examples of using deprecated features
...
==== Examples of using deprecated features without replacement in future
...
==== Examples of using a deprecated feature that will be replaced in future
...
Returned Status Description::
warn: feature deprecated with replacement.
`shortestPath((n)-[r]->(m))` is deprecated.
