...
Suggestions for improvement::
The existing index is likely what was wanted, no further actions needed.
...
Suggestions for improvement::
Chose a different name for the new index and try again as the existing index was not similar to the one attempting to be created.
+
[source, cypher]
----
...
Suggestions for improvement::
The existing constraint is likely what was wanted, no further actions needed.
...
Suggestions for improvement::
Chose a different name for the new constraint and try again as the existing constraint was not similar to the one attempting to be created.
+
[source, cypher]
----
