...
.Using an unescaped variable named 'where' in node
[.tabbed-example]
=====
[.include-with-neo4j-code]
======
...
.Using an unescaped variable named 'where' in relationship patterns
[.tabbed-example]
=====
[.include-with-neo4j-code]
======
...
.Using an unescaped variable named `contains` for relationships in addition or subtraction operations within a `WHEN` operand in a simple `CASE` expression
[.tabbed-example]
=====
[.include-with-neo4j-code]
======
...
.Using an unescaped variable named `contains` for nodes in addition or subtraction operations within a `WHEN` operand in a simple `CASE` expression
[.tabbed-example]
=====
[.include-with-neo4j-code]
======
