...
m|01N51
|StatusDescription
a|warn: unknown relationship type. The relationship type `$rel` does not exist. Verify that the spelling is correct.
|Severity
m|WARNING
|Classification
m|UNRECOGNIZED
...
m|01N52
|StatusDescription
a|warn: unknown property key. The property `$prop` does not exist. Verify that the spelling is correct.
|Severity
m|WARNING
|Classification
m|UNRECOGNIZED
