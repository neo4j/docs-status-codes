...
=== Statement.CodeGenerationFailed
...
=== Statement.JoinHintUnfulfillableWarning
...
=== Statement.UnknownRelationshipTypeWarning
...
=== Statement.UnknownPropertyKeyWarning
...
=== Statement.RuntimeUnsupportedWarning
...
=== Statement.FeatureDeprecationWarning
...
=== Statement.UnsatisfiableRelationshipTypeExpression
...
=== Statement.RepeatedRelationshipReference
