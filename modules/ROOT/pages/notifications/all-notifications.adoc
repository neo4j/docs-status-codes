...
Notifications within this group contain information about a deprecated feature or functionality.
...
==== Examples of using deprecated features without a future replacement
...
==== Examples of using a deprecated feature that will be replaced in the future
