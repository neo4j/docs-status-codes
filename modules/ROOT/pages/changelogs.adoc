...
The GqlStatusObject API provides diagnostic information about the status of a Cypher query or command execution in compliance with the GQL standard.
...
For more information, see xref:notifications/index.adoc[Server notifications] and xref:notifications/all-notifications.adoc[List of all server notification codes].
