...
The query returns an error with GQLSTATUS 22NAE and status description:

.GQLSTATUS error
[source, error]
----
22NAE: data exception - multi-line field in illegal CSV context. Multi-line fields are illegal in this context. Verify that there is not a missing end quote in 'somefile.csv' at position 15.
----
