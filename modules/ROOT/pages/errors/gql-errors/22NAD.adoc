...
The query returns an error with GQLSTATUS 22NAD and status description:

.GQLSTATUS error
[source, error]
----
22NAD: data exception - missing end quote in CSV field. Missing end quote at position 15 in 'somefile.csv'.
----
