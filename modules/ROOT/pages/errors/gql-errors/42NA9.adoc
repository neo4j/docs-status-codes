...
The query returns an error with GQLSTATUS xref:errors/gql-errors/42001.adoc[42001] and a cause GQLSTATUS xref:errors/gql-errors/42N17.adoc[42N17] that has a subsequent cause with GQLSTATUS 42NA9 with the status description:
