...
Status description:: error: data exception - operation not allowed here. Invalid input: '{ <<query>> }' is not allowed for roles that are granted to an AUTH RULE.

// TODO don't know release date yet
[role=label--new-2025.XX]
=== xref:errors/gql-errors/22ND2.adoc[22ND2]

Status description:: error: data exception - operation not allowed here. Invalid input: '{ <<query>> }' is not allowed for roles with DENY privileges.
>>>>>>> 60e62c6 (Add 22ND1 and 22ND2)
