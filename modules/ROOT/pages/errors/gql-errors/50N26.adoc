...
== Example scenario
Try creating a database using the following command:
...
If the backup at `$uri` contains invalid Cypher syntax in its metadata script, the command will return an error with GQLSTATUS 50N26.
