...
Starting with Neo4j 2026.06, the `WHERE` clause is also allowed on the `system` database when combined with procedure calls, and the above example query works as expected.
====
