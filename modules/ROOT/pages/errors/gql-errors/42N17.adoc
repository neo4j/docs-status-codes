...
From 2026.06 onwards, the `WHERE` clause, when combined with procedure calls, is allowed on the `system` database, and the following example query works as expected.
====
