...
The query returns the following error with GQLSTATUS xref:errors/gql-errors/42001.adoc[42001] and a cause GQLSTATUS 42N17 that has a subsequent cause with GQLSTATUS xref:errors/gql-errors/42NA9.adoc[42NA9]:
...
The query returns the following error with GQLSTATUS xref:errors/gql-errors/42001.adoc[42001] and a cause GQLSTATUS 42N17:
