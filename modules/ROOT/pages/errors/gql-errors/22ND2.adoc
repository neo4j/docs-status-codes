...
For example, you can replace the generic deny from step 1 in the <<example-scenario-22nd2, Example scenario>> with the following more fine-grained alternative:

. Revoke the denied privilege to reproduce the original scenario:
+
[source, cypher]
----
