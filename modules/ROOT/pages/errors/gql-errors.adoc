...
[WARNING]
====
Please note that while GQLSTATUS codes remain stable, the descriptions associated with these codes may change over time.
For this reason, parsing the descriptions or incorporating them into scripts is not recommended.
====
