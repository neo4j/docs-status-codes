...
Status description:: error: procedure exception - must invoke procedure on secondary. Can't invoke procedure on this member because it is not a secondary for database `{ $db }`.
