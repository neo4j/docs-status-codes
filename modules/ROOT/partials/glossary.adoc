...
[[argList]]$argList:: A list of procedure or function arguments, for example, `edition, name and versions`.
...
[[secretProviderType]]$secretProviderType:: The secret provider backed used by the secret manager, for example 'AWS', 'GCP', etc.
