...
| Message (A new component that will replace the notification title and description, and the error description in 6.0)
| See <<message, Message>>.
...
The notification title and description will be merged in 6.0, and the error description will be replaced by the message.
See <<message, Message>>.
...
The notification description will be removed in 6.0, and the message will be used instead.
...
The notification and error message will replace the notification title and description, and the error description in 6.0.
It should follow the same guidelines as the notification description, namely:
...
Add one or more example queries to illustrate the possible scenarios when this notification or error would be returned.
